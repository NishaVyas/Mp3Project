<%-- 
    ...
    Created on : 7 Sep, 2022, 5:34:41 PM
    Author     : Nisha
--%>
    ...
    <body class="sidebar-menu-collapsed">
     ...
     <div class="main-content">
         <div class="content-wrapper">
               <div class="row-1">
                    <div class="col-sm-9">
                          <form method="post" action="upload_song.jsp?album_code=<%=album_code%>&sn=<%=sn%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                              <div class="form-group">
                                <label>Song Upload:</label>&nbsp;&nbsp;<input type="file" name="uploadFile" class="form-control"><br><br>
